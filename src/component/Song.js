            ...
            <div className='d-flex mt-3'>
                ...
                <div className="card  w-50 p-2 " >
                    <div className="row h-25">
                        <div className="col-md-4">
                            <img src={item[0].album.cover} className=" rounded-start w-100" alt="..." />
                        </div>
                        <div className="col-md-8">
                            <div className="card-body">
                                <h5 className="card-title">{item[0].title_short}</h5>
                    ...
                    <div className='d-flex mh-100 flex-column   w-100  justify-content-center text-center align-content-center' >
                        <div className=' justify-content-center '>
                            ...
                            <div className='d-flex justify-content-center'>
                                <img className='w-25' src={item[0].artist.picture_medium} ></img>
                                <div className='flex-direction: column p-4 my-1'>
                                    <h3>{item[0].title_short}</h3>
                                    <Link to={`/about/${item[0].id}`}><h5 className='mt-5'>{item[0].artist.name}</h5></Link>
                                </div>
