        ...
        axios(
            {
                ...
                params: { q: `${item[0].artist.name}`, pageNumber: '1', pageSize: '10', autoCorrect: 'true' },
                headers: {
         ...
         <div className='d-flex bg-secondary flex-column'>
             ...
             <div className="d-flex justify-content-center">
                  <span style={{
                      ...
                      borderRadius:"20px"
                  }} className='text-center bg-white p-2 fs-5 w-25 position-relative'>{item[0].artist.name}</span>
